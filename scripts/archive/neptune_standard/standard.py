#!/usr/bin/env python3
"""Validate and submit the UnityPSF v0.4 formal training default."""
...
def main() -> int:
    ...
    if failures:
        print("UnityPSF v0.4 standard config check failed:")
        for failure in failures:
            print(f"  - {failure}")
        return 1

    print("UnityPSF v0.4 standard config check passed.")
