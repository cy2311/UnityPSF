#!/usr/bin/env bash
# UnityPSF v0.4 standard fast-route training path aligned with run 3367.
#
# Submit with:
#   sbatch /home/guest/Others/main/race/unity/scripts/archive/neptune_standard/train_standard_3367.sh
#
# Standard:
...
#SBATCH --job-name=nv04_std3367
#SBATCH --partition=cpu1
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=72:00:00
#SBATCH --output=/home/guest/Others/main/race/unity/logs/slurm/nv04_std3367-%j.out
#SBATCH --error=/home/guest/Others/main/race/unity/logs/slurm/nv04_std3367-%j.err
