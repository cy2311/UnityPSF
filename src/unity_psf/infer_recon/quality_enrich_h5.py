...
from unity_psf.infer_recon.predictions_io import H5PredictionWriter, prediction_fieldnames
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Enrich Neptune v0.4 predictions H5 with raw-TIFF post-fit quality metrics.")
