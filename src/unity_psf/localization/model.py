...
def build_localization_model_registry():
    ...
    def active_smlm_soft_moe_double_unet(params: dict[str, object]) -> torch.nn.Module:
        from unity_psf.localization.soft_moe import SoftMoEFiLMExperts
    ...
    def astigmatism_expert(params: dict[str, object]) -> torch.nn.Module:
        from unity_psf.models.psf_moe.experts.astigmatism import AstigmatismExpert

        return AstigmatismExpert(**params)

    def emitter_2d_expert(params: dict[str, object]) -> torch.nn.Module:
    ...
    def double_helix_expert(params: dict[str, object]) -> torch.nn.Module:
        ...
        return DoubleHelixImageExpert(**params)
