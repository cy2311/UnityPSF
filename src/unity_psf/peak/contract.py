...
from unity_psf.runtime.artifacts import ArtifactRegistry
from unity_psf.runtime.layout import RunLayout, write_stage_status
...
class PeakBootstrapConfig:
    ...
    initial_zernike_coefficients_nm: dict[str, float] = field(default_factory=dict)
    local_z_range_nm: tuple[float, float] = (-600.0, 600.0)
    ...
    def to_json_dict(self) -> dict[str, Any]:
        ...
        payload["local_z_range_nm"] = [
            float(self.local_z_range_nm[0]),
            float(self.local_z_range_nm[1]),
        ]
