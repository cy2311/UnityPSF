#!/usr/bin/env bash
# Neptune v0.3 default run-3371 route: fast training with freshly recomputed raw-TIFF high-quality initial zmap.
#
# Submit with:
#   sbatch /home/guest/Others/main/race/neptune_v0.3/train_standard_3367_hqzmap.sh
#
# Stage 1:
...
#SBATCH --job-name=nv03_3367hq
#SBATCH --partition=cpu1
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=72:00:00
#SBATCH --output=/home/guest/Others/main/race/neptune_v0.3/logs/slurm/nv03_3367hq-%j.out
#SBATCH --error=/home/guest/Others/main/race/neptune_v0.3/logs/slurm/nv03_3367hq-%j.err
...
mkdir -p "$NEPTUNE_DIR/logs/slurm" "$HQ_ZMAP_ROOT"
...
"$PY" -u "$NEPTUNE_DIR/scripts/train/run_high_quality_initial_zmap.py" "${left_hq_args[@]}" &
left_pid=$!

echo "start_zmap_side=right device=${right_device}"
"$PY" -u "$NEPTUNE_DIR/scripts/train/run_high_quality_initial_zmap.py" "${right_hq_args[@]}" &
right_pid=$!
